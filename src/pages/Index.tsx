    ...
    <div className="min-h-screen flex flex-col bg-[var(--bg-primary)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="text-center md:text-left animate-in">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 bg-gradient-to-r from-wash-blue to-wash-teal bg-clip-text text-transparent leading-tight">
                RoboWash <span className="block mt-2">{t('hero.title')}</span>
              </h1>
      ...
      <section id="book" className="py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-lg mx-auto glass-effect rounded-2xl shadow-xl p-6 border-[var(--bg-tertiary)]">
            <ReservationForm />
          </div>
        </div>
      </section>
      ...
      <section id="reviews" className="py-16 bg-gradient-to-b from-[var(--bg-secondary)] to-[var(--bg-primary)] relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-lg mx-auto mt-16 glass-effect rounded-2xl shadow-xl p-8 border-[var(--bg-tertiary)]">
      ...
      <section id="location" className="py-16 bg-gradient-to-b from-[var(--bg-primary)] to-[var(--bg-secondary)]">
        <div className="container mx-auto px-4">
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl border-[var(--bg-tertiary)]">
            <Map />
          </div>
        </div>
      </section>
